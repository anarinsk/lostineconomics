...
데이터의 출처는 업계에서 많이 찹고하는 ㅇㅇㄴ이다.[^aan] 보통 분석 내용과 함께 원데이터 및 데이터 가공과 분석에 활용된 소스코드를 공개하는 것이 원칙이다. 아쉽게도 이용한 원자료를 공개할 권리가 나에게 없다. 이 점 양해 부탁한다. 요청이 있다면 데이터 정리 및 분석에 동원된 코드는 공개할 수 있다. 
